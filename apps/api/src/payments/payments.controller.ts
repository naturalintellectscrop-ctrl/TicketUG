...
export class PaymentsController {
  ...
  @Post('orders/:publicId/payment/test-complete') simulateTestSuccessForUser(@CurrentUser() user: ApiUser, @Param('publicId') publicId: string) { return this.payments.simulateTestSuccessForUser(user, publicId) }
