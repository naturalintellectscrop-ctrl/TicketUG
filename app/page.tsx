  ...
  return (
    <main className="min-h-screen overflow-hidden">
      ...
      <section id="how-it-works" className="rhythm-section">
        <div className="section-intro"><p className="eyebrow">The rhythm</p><h2>One platform.<br /><span>Every kind of gathering.</span></h2></div>
      ...
      <section id="events" className="events-banner"><div><p className="eyebrow">Coming together</p><h2>Your next moment<br /><em>is already here.</em></h2></div><div className="banner-side"><p>From rooftop sets to community stages, find your next reason to step into something shared.</p><Link href="/sign-up" className="text-link">Get on the list <span aria-hidden="true">↗</span></Link></div></section>
